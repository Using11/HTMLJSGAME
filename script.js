...
class component {
  constructor(x,y,width,height,fillColor,strokeColor,strokeWidth,radiusBool,isCoin){
    ...
    this.sideCollisionCheck = function(obj){
      if((this.x + this.width + 1 >= obj.x && (this.y - this.height >= obj.y && this.y <= obj.y + obj.height)) && this.x - 3 <= obj.x + obj.width){
        this.xMove = 0;
      ...
      if(this.x - 3 <= obj.x + obj.width && (this.y - this.height >= obj.y && this.y <= obj.y + obj.height) && this.x + this.width + 1 >= obj.x){
        this.xMove = 0;
